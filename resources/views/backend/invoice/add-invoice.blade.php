                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" name="invoice_no" id="invoice_no" value="{{$invoice_no}}" class="form-control" readonly style="background-color: #D8FA3C"/>
                                    </div>
                                    <div class="form-group col-md-2">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" name="current_stock_qty" id="current_stock_qty" class="form-control" readonly style="background-color: #D8FA3C">
                                    </div>
